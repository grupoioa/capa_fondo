...
### Prerrequisitos
Esto se realizó sobre Ubuntu 16.04 LTS y con `python 3.6`, las herramientas que se necesitan tener instaladas son :
...
### Generamos la piramide de mosaicos
   ...
   `**gdal_retile.py** -v -r bilinear -levels 4 -ps 2048 2048 -co "TILED=YES" -co "COMPRESS=JPEG" -targetDir *directorio*    *capa_fondo.tif*`

## Construido con
*[Python](https://www.python.org/) Lenguaje de progración
*[GDAL](https://www.gdal.org/) Librería usada.

## Versionando

Usamos [SemVer](https://semver.org/lang/es/) para versionar. Para las versiones disponibles, consulte  
[las etiquetas en este repositorio](https://github.com/your/project/tags).

## Autores
* **Raúl Medina Peña** - *Initial work* - [rmedina09](https://github.com/rmedina09)
